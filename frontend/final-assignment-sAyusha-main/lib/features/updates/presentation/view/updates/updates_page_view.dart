...
class UpdatesPageView extends ConsumerStatefulWidget {
  const UpdatesPageView({super.key});

  @override
  ConsumerState<UpdatesPageView> createState() => _UpdatesPageViewState();
}

class _UpdatesPageViewState extends ConsumerState<UpdatesPageView> {
