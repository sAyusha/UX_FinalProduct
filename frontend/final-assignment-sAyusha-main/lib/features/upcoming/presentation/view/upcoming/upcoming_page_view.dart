...
class UpcomingPageView extends ConsumerStatefulWidget {
  const UpcomingPageView({super.key});

  @override
  ConsumerState<UpcomingPageView> createState() => _UpcomingPageViewState();
}

class _UpcomingPageViewState extends ConsumerState<UpcomingPageView> {
